...
Some options in here are user configurable from a :class:`golos.api.Api` instance, however some options are global
and can only be overridden from this module.
...
"""
# https://wiki.golos.io/golosd/HardFork/HF19_ReleaseNotice-rus.html
...
"""
This is a list of GOLOS nodes which are used by default by :py:class:`golos.api.Api` if no nodes are specified
by the user.
"""
...
"""Map operations names from :py:attr:`.op_names` to their operation ID"""
